...
| ----- | ----------- | ------------- | -------------- | -------------- | ------------ |
| [3.8.2](#382-release-2026-03-23) | `v3.8.2` | [3.9.0](https://docs.stardog.com/release-notes/stardog-cloud/stardog-designer#v390-release) | [3.1.7](https://docs.stardog.com/release-notes/stardog-cloud/stardog-explorer#v317-release) | [5.9.5](https://docs.stardog.com/release-notes/stardog-cloud/stardog-studio#v595-release) | [1.4.28](https://docs.stardog.com/release-notes/stardog-cloud/stardog-knowledge-catalog#v1428-release) |
